...
// 1920 x 1200 is the preferred 16:10 mode used by the tablet stream.
...
// EDID derived from the Microsoft IndirectDisplay sample. The product name,
// stable serial and checksum identify this endpoint as TabletMonitor.
    ...
    {
        {
            ...
            0x58,0x42,0x59,0x32,0x0A,0x20,0x20,0x20,0x20,0x20,0x00,0x00,0x00,0xFC,0x00,0x54,
            0x61,0x62,0x6C,0x65,0x74,0x4D,0x6F,0x6E,0x69,0x74,0x6F,0x72,0x00,0x00,0x00,0xFD,
            0x00,0x28,0x9B,0xFA,0xFA,0x40,0x01,0x0A,0x20,0x20,0x20,0x20,0x20,0x20,0x00,0x69
        },
        {
            { 1920, 1200, 60 },
            { 1920, 1080, 60 },
...
EVT_WDF_DRIVER_DEVICE_ADD TabletMonitorDeviceAdd;
EVT_WDF_DEVICE_D0_ENTRY TabletMonitorDeviceD0Entry;

EVT_IDD_CX_ADAPTER_INIT_FINISHED TabletMonitorAdapterInitFinished;
EVT_IDD_CX_ADAPTER_COMMIT_MODES TabletMonitorAdapterCommitModes;

EVT_IDD_CX_PARSE_MONITOR_DESCRIPTION TabletMonitorParseMonitorDescription;
EVT_IDD_CX_MONITOR_GET_DEFAULT_DESCRIPTION_MODES TabletMonitorMonitorGetDefaultModes;
EVT_IDD_CX_MONITOR_QUERY_TARGET_MODES TabletMonitorMonitorQueryModes;

EVT_IDD_CX_MONITOR_ASSIGN_SWAPCHAIN TabletMonitorMonitorAssignSwapChain;
EVT_IDD_CX_MONITOR_UNASSIGN_SWAPCHAIN TabletMonitorMonitorUnassignSwapChain;
...
_Use_decl_annotations_
NTSTATUS TabletMonitorDeviceAdd(WDFDRIVER Driver, PWDFDEVICE_INIT pDeviceInit)
{
    ...
    PnpPowerCallbacks.EvtDeviceD0Entry = TabletMonitorDeviceD0Entry;
    ...
    // IddConfig.EvtIddCxDeviceIoControl = TabletMonitorIoDeviceControl;

    IddConfig.EvtIddCxAdapterInitFinished = TabletMonitorAdapterInitFinished;

    IddConfig.EvtIddCxParseMonitorDescription = TabletMonitorParseMonitorDescription;
    IddConfig.EvtIddCxMonitorGetDefaultDescriptionModes = TabletMonitorMonitorGetDefaultModes;
    IddConfig.EvtIddCxMonitorQueryTargetModes = TabletMonitorMonitorQueryModes;
    IddConfig.EvtIddCxAdapterCommitModes = TabletMonitorAdapterCommitModes;
    IddConfig.EvtIddCxMonitorAssignSwapChain = TabletMonitorMonitorAssignSwapChain;
    IddConfig.EvtIddCxMonitorUnassignSwapChain = TabletMonitorMonitorUnassignSwapChain;
...
_Use_decl_annotations_
NTSTATUS TabletMonitorDeviceD0Entry(WDFDEVICE Device, WDF_POWER_DEVICE_STATE PreviousState)
{
...
void IndirectDeviceContext::InitAdapter()
{
    ...
    AdapterCaps.EndPointDiagnostics.pEndPointFriendlyName = L"TabletMonitor Virtual Display";
    AdapterCaps.EndPointDiagnostics.pEndPointManufacturerName = L"TabletMonitor";
    AdapterCaps.EndPointDiagnostics.pEndPointModelName = L"Galaxy Tab S9 FE 5G";
...
void IndirectDeviceContext::FinishInit(UINT ConnectorIndex)
{
    ...
    MonitorInfo.MonitorContainerId = { 0x2F84168B, 0xA141, 0x4A96, { 0x91, 0x19, 0x6D, 0x62, 0x7D, 0x56, 0xA8, 0x3E } };
...
_Use_decl_annotations_
NTSTATUS TabletMonitorAdapterInitFinished(IDDCX_ADAPTER AdapterObject, const IDARG_IN_ADAPTER_INIT_FINISHED* pInArgs)
{
...
_Use_decl_annotations_
NTSTATUS TabletMonitorAdapterCommitModes(IDDCX_ADAPTER AdapterObject, const IDARG_IN_COMMITMODES* pInArgs)
{
...
_Use_decl_annotations_
NTSTATUS TabletMonitorParseMonitorDescription(const IDARG_IN_PARSEMONITORDESCRIPTION* pInArgs, IDARG_OUT_PARSEMONITORDESCRIPTION* pOutArgs)
{
    // ==============================
...
_Use_decl_annotations_
NTSTATUS TabletMonitorMonitorGetDefaultModes(IDDCX_MONITOR MonitorObject, const IDARG_IN_GETDEFAULTDESCRIPTIONMODES* pInArgs, IDARG_OUT_GETDEFAULTDESCRIPTIONMODES* pOutArgs)
{
...
_Use_decl_annotations_
NTSTATUS TabletMonitorMonitorQueryModes(IDDCX_MONITOR MonitorObject, const IDARG_IN_QUERYTARGETMODES* pInArgs, IDARG_OUT_QUERYTARGETMODES* pOutArgs)
{
    UNREFERENCED_PARAMETER(MonitorObject);
...
_Use_decl_annotations_
NTSTATUS TabletMonitorMonitorAssignSwapChain(IDDCX_MONITOR MonitorObject, const IDARG_IN_SETSWAPCHAIN* pInArgs)
{
...
_Use_decl_annotations_
NTSTATUS TabletMonitorMonitorUnassignSwapChain(IDDCX_MONITOR MonitorObject)
{
    auto* pMonitorContextWrapper = WdfObjectGet_IndirectMonitorContextWrapper(MonitorObject);
